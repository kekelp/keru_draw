...
impl State {
    ...
    fn render(&mut self) -> Result<(), wgpu::SurfaceError> {
        ...
        self.renderer.draw_box(Box {
            ...
            fill: ColorFill::Color([0.015686, 0.666667, 0.427451, 1.0]),
            x_clip: clip_x,
            y_clip: clip_y,
            texture: None,
        });
        ...
        self.renderer.draw_box(Box {
            ...
            rounded_corners: RoundedCorners::ALL,
            border_thickness: 5.0,
            fill: ColorFill::Color([0.8, 1.0, 0.3, 1.0]),
            x_clip: clip_x,
            y_clip: clip_y,
            texture: None,
        });
        ...
        self.renderer.draw_box(Box {
            ...
            border_thickness: 0.0,
            fill: ColorFill::Color([0.6, 0.3, 0.9, 1.0]),
            x_clip: clip_x,
            y_clip: clip_y,
            texture: None,
        });
        ...
        self.renderer.draw_box(Box {
            ...
            border_thickness: 0.0,
            fill: ColorFill::Color([0.9, 0.5, 0.2, 1.0]),
            x_clip: clip_x,
            y_clip: clip_y,
            texture: None,
        });
        ...
        self.renderer.draw_circle(Circle {
            center: [250.0, 150.0],
            radius: 40.0,
            fill: ColorFill::Color([0.3, 0.9, 1.0, 1.0]),
            x_clip: clip_x,
            y_clip: clip_y,
            texture: None,
        });
        ...
        self.renderer.draw_ring(Ring {
            ...
            inner_radius: 35.0,
            outer_radius: 40.0,
            fill: ColorFill::Color([1.0, 1.0, 0.3, 1.0]),
            x_clip: clip_x,
            y_clip: clip_y,
            texture: None,
        });
        ...
        self.renderer.draw_ring(Ring {
            ...
            inner_radius: 30.0,
            outer_radius: 45.0,
            fill: ColorFill::Color([1.0, 0.8, 0.3, 1.0]),
            x_clip: clip_x,
            y_clip: clip_y,
            texture: None,
        });
        ...
        self.renderer.draw_ring(Ring {
            ...
            inner_radius: 25.0,
            outer_radius: 50.0,
            fill: ColorFill::Color([1.0, 0.6, 0.3, 1.0]),
            x_clip: clip_x,
            y_clip: clip_y,
            texture: None,
        });
        ...
        self.renderer.draw_segment(Segment {
            ...
            thickness: 3.0,
            fill: ColorFill::Color([1.0, 0.5, 0.0, 1.0]),
            x_clip: clip_x,
            y_clip: clip_y,
            dash_length: None,
            texture: None,
        ...
        self.renderer.draw_segment(Segment {
            ...
            thickness: 6.0,
            fill: ColorFill::Color([1.0, 0.6, 0.0, 1.0]),
            x_clip: clip_x,
            y_clip: clip_y,
        ...
        self.renderer.draw_segment(Segment {
            ...
            thickness: 10.0,
            fill: ColorFill::Color([1.0, 0.7, 0.0, 1.0]),
            x_clip: clip_x,
            y_clip: clip_y,
        ...
        self.renderer.draw_segment(Segment {
            ...
            thickness: 8.0,
            fill: ColorFill::Color([1.0, 0.8, 0.0, 1.0]),
            x_clip: clip_x,
            y_clip: clip_y,
        ...
        self.renderer.draw_hexagon(Hexagon {
            ...
            size: 40.0,
            rotation: 0.0,
            fill: ColorFill::Color([0.2, 0.7, 0.9, 1.0]),
